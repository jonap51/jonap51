...
🚀 **Passion for technology:** A constant driving force in my life.

🧪 **Previous professional experience:**
Worked in a chemical lab, involved in perfume creation and application.
* Fine fragrance perfumes.
* Body care products.
* Home care products.

🖥️ **Previous technological interests and projects:**
* Game development using the Unity engine.
* Exploration of Augmented Reality with the Spark AR platform.
* Implementation of applications in Java for Android.

🎯 **Current professional focus:** Developing websites and web applications.
